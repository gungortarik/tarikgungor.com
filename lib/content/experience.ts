...
export const experiences: WorkExperience[] = [
  ...
  {
    company: "Payment Source, Inc.",
    role: "Technology Support Intern (Co-op)",
    location: "Toronto, ON",
    period: "Apr — Jul 2023",
    bullets: [
      "BCIT Technology Support Professional co-op placement in the company IT department",
      "Supported new-hire onboarding by preparing computers and IT equipment",
      "Provided end-user IT support primarily through Google Chat and Google Meet",
      "Enrolled Windows endpoints into GCPW and macOS devices into Hexnode",
      "Worked with CrowdStrike Falcon for endpoint cybersecurity protection",
      "Contributed to ManageEngine Endpoint Central transition and **50+ endpoint configurations**",
      "Validated configurations on test devices before phased Windows and macOS deployment",
      "Completed company-wide IT asset inventory and maintained technical documentation",
    ],
  },
];
...
export const educationList: Education[] = [
  ...
  },
  {
    ...
    program: "Technology Support Professional — Certificate",
